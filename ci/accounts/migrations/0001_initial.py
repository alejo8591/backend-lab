...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'accounts_userprofile_skills')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'accounts.userprofile'], null=False)),
            ('skills', models.ForeignKey(orm[u'accounts.skills'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_skills')

        # Deleting model 'UserProfile'
        db.delete_table(u'accounts_userprofile')

        # Removing M2M table for field skills on 'UserProfile'
        db.delete_table(db.shorten_name(u'accounts_userprofile_skills'))
    ...
    models = {
        ...
        u'accounts.userprofile': {
            ...
            'skills': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.Skills']", 'symmetrical': 'False'}),
